...
beam_Bending_Q8_4x1_Al = Solver("Beam_Bending_Q8_4x1_Al.txt", override);
beam_Bending_Q9_4x1_Al = Solver("Beam_Bending_Q9_4x1_Al.txt", override);

log_lengths = [log(12/4), log(12/8) log(12/16)];
figure
plot(log_lengths, [...
        log(abs(beam_Bending_Q4_4x1_Al.interpolate_displacement(2) - reaction)/abs(reaction)), ...
